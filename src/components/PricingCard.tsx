  ...
  return (
    <div className={`bg-white rounded-lg shadow-md overflow-hidden ${isPopular ? 'ring-2 ring-rose-500 transform scale-105' : ''}`}>
      ...
      <div className="p-6">
        ...
        <button className={`w-full py-2 px-4 rounded-md font-medium transition-colors ${isPopular ? 'bg-rose-500 text-white hover:bg-rose-600' : 'bg-gray-100 text-gray-800 hover:bg-gray-200'}`}>
          Choose Plan
        </button>
      </div>
    </div>
